  ...
  return (
    <div className="flex flex-col items-center">
      ...
      >
        ...
        <h3 className="text-2xl sm:text-3xl font-bold text-center text-pink-600 mt-2">To Muhib's Mother</h3>
      </motion.div>
          ...
          <AnimatePresence>
            ...
            >
              <div className="text-center">
                ...
                May Allah bless you and give you live long life with full of joy's many many returns of the day
                </p>
      ...
      >
        <div className="text-center">
          ...
          <div className="flex justify-center items-center gap-2">
            <p className="text-pink-600 font-medium">Once Again Happy birthday to you 🥀❤</p>
          </div>
        </div>
      </motion.div>
    </div>
